        ...
        return (
            <div className='pc-miniapp'>
                        <div className='content-1 miniapp-content-1'>
                            ...
                            <SymmetryWave />
                            <img className='phone-mockup' src={`${process.env.REACT_APP_CDN_IMAGE_HOST}/phone1.png`} alt={'phone1'} />
                        </div>
                        <div id='ceshi2' className='miniapp-content-2'>
                            <h1>自定义你的品牌权益</h1>
                            <img src={`${process.env.REACT_APP_CDN_IMAGE_HOST}/phone2.png`} alt={'phone2'} />
                        </div>
                        <Footer />
            </div>
        )
